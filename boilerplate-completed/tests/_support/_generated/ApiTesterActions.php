<?php  //[STAMP] a6fd02833581c900036e8a83901987a6
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::grabHashname()
     */
    public function grabHashname() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabHashname', func_get_args()));
    }
}
